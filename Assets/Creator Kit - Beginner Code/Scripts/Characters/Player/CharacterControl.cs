...
namespace CreatorKitCodeInternal
{
        ...
        AnimationControllerDispatcher.IFootstepFrameReceiver
    {
        ...
        void Update()
        {
            ...
            //Added a LeftCTRL check
            if (!EventSystem.current.IsPointerOverGameObject() && m_CurrentState != State.ATTACKING && !Input.GetKey(KeyCode.LeftControl))
            {
        ...
        void CheckAttack()
        {
            ...
            {
                //Do not keep following the thing you are attacking...
